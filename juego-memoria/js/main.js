const MAXIMOS_INTENTOS = 5,
    ...
    NOMBRE_IMAGEN_OCULTA = "https://i.postimg.cc/X7t3jWgj/Dise-o-sin-t-tulo.png";
new Vue({
    el: "#app",
    data: () => ({
        imagenes: [
            "https://i.postimg.cc/dtHLWQLB/aston.png",
            "https://i.postimg.cc/6QRq5dzj/city.png",
            "https://i.postimg.cc/wMF7YgF9/liverpool.png",
            "https://i.postimg.cc/sgM1bFWR/newcastle.png",
            "https://i.postimg.cc/HnTVNVwS/united.png",
            "https://i.postimg.cc/G3jByxR6/west.png",
        ],
        memorama: [],
        ultimasCoordenadas: {
            indiceFila: null,
